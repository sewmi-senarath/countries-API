...
function App() {
  ...
  // Reset filteredCountries when navigating to home page
  useEffect(() => {
    if (location.pathname === '/') {
      console.log('App useEffect: Navigated to home, resetting filteredCountries');
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <Link
                ...
                onClick={resetSearch} // Reset search on clicking logo
              >
              ...
              <div className="flex items-center space-x-6 mt-4 md:mt-0">
                <div className="hidden md:flex items-center space-x-6">
                  <Link
                    ...
                    onClick={resetSearch} // Reset search on clicking Home
                  >
                ...
                <div className="flex flex-col md:flex-row md:space-x-4 mb-6 items-center">
                  <div className="w-full md:w-2/3">
                    <SearchBar
                      ...
                      isMapView={isMapView}
                      resetSearch={resetSearch} // Pass resetSearch to SearchBar
                    />
                  </div>
          ...
          element={
            <ProtectedRoute isAuthenticated={isAuthenticated}>
              <CountryDetail
                favorites={favorites}
                toggleFavorite={toggleFavorite}
                resetSearch={resetSearch} // Pass resetSearch to CountryDetail
              />
            </ProtectedRoute>
          }
        />
